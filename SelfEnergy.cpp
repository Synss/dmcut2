...
#include "Site.hpp"
double Interactions::SelfEnergy::operator()(const Surface::Site& site) const
{
	SelfEnergy::container_type::const_iterator
	cit = container_.find(std::make_pair(site.species(), site.name()));
